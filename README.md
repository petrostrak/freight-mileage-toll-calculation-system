...
make obu
```
Now, based on a `obuID` we can make a request to the `Invoicer Calculator` and get the total distance and amount:
```bash
curl http://localhost:3010/invoice?obuID=6650711713076780301
```